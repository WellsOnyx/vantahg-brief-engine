...
| — | [um-unit-economics-rate-card.md](um-unit-economics-rate-card.md) | Locked 2026-09-23 planning rate card. Rules-only/auto not billed; nurse / MD / external peer billed. Not a new SKU |
