 ...
 *
 * Usage:
 *   node scripts/load-test-firstmover.mjs [base_url]
 *
...
async function warm() {
  ...
  await fetch(`${BASE}/api/firstmover/intake`, {
    method: 'POST',
...
async function fireOne(i) {
  ...
  try {
    const res = await fetch(`${BASE}/api/firstmover/intake`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
