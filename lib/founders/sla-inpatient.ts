/**
 * Inpatient + continued-stay SLA logic for Founders intake.
 *
 ...
 * the values in `lib/sla-calculator.ts` but exposed through the founders
 * namespace so the manual MVP doesn't reach across the import boundary.
 */
export const FOUNDERS_SLA_HOURS = {
