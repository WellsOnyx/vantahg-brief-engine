...
export const demoReviewers: Reviewer[] = [
  {
    ...
    dea_number: null,
    email: 'j.richardson@vantaum.com',
    phone: '(602) 555-0147',
    status: 'active',
...
export const demoClients: Client[] = [
  {
    ...
    interqual_portal_url: 'https://interqual.changehealthcare.com',
    interqual_username: 'swa-vantaum-reviewer',
    interqual_api_key: '••••••••••••iq_4f8a',
    mcg_portal_url: null,
    mcg_username: null,
    mcg_api_key: null,
  ...
  },
  {
    ...
    interqual_portal_url: null,
    interqual_username: null,
    interqual_api_key: null,
    mcg_portal_url: 'https://cite.mcg.com',
    mcg_username: 'pinnacle-vum-ops',
  ...
  },
  {
    ...
    interqual_portal_url: 'https://interqual.changehealthcare.com',
    interqual_username: 'wet-vantaum-ops',
    interqual_api_key: '••••••••••••iq_7c1e',
    mcg_portal_url: 'https://cite.mcg.com',
    mcg_username: 'wet-vum-reviewer',
    mcg_api_key: null,
...
export const demoCases: Case[] = [
  ...
  // CASE 5: Psychotherapy - Completed, Denied
  {
    ...
    appeal_status: null,
    physician_ai_agreement: 'agree',
    physician_ai_feedback_notes: 'AI correctly identified treatment plateau and recommended denial. Criteria analysis was accurate.',
    denial_strength_score: 78,
    denial_strength_grade: 'moderate',
    two_midnight_applies: false,
    payer_classification: 'commercial',
...
export const demoAuditLog: AuditLogEntry[] = [
  // --- Case 1: MRI Lumbar Spine (full workflow, approved) ---
  {
    ...
    action: 'case_created',
    actor: 'system',
    details: { case_number: 'VUM-MED-0201', vertical: 'medical', service_category: 'imaging', source: 'portal_submission' },
  },
  {
    id: 'audit-001-02',
  ...
  // --- Case 2: Total Knee Arthroplasty (in review) ---
  {
    ...
    action: 'case_created',
    actor: 'system',
    details: { case_number: 'VUM-MED-0202', vertical: 'medical', service_category: 'surgery', source: 'portal_submission' },
  },
  {
    id: 'audit-002-02',
  ...
  // --- Case 3: Infliximab Infusion (brief ready, not yet assigned) ---
  {
    ...
    action: 'case_created',
    actor: 'system',
    details: { case_number: 'VUM-MED-0203', vertical: 'medical', service_category: 'infusion', source: 'portal_submission', priority: 'urgent' },
  },
  {
    id: 'audit-003-02',
  ...
  // --- Case 4: CPAP Device (just submitted) ---
  {
    ...
    action: 'case_created',
    actor: 'system',
    details: { case_number: 'VUM-MED-0204', vertical: 'medical', service_category: 'dme', source: 'portal_submission', priority: 'standard' },
  },
  ...
  // --- Case 5: Psychotherapy (denied) ---
  {
    ...
    action: 'case_created',
    actor: 'system',
    details: { case_number: 'VUM-MED-0199', vertical: 'medical', service_category: 'behavioral_health', source: 'portal_submission' },
  },
  {
    id: 'audit-005-02',
  ...
  // --- Case 6: Lumbar Epidural Steroid Injection (in review) ---
  {
    ...
    action: 'case_created',
    actor: 'system',
    details: { case_number: 'VUM-MED-0200', vertical: 'medical', service_category: 'pain_management', source: 'portal_submission', priority: 'expedited' },
  },
  {
    id: 'audit-006-02',
