...
export const DEMO_CASE_IDS = {
  ...
  // IDR / Payer IDR demo cases for training & testing the IDR chassis
  idrAirAmbulance: 'case-idr-001-air-ambulance',
  idrFacilityFee: 'case-idr-002-out-of-network-facility',
  // IRO/IRE demo cases (external/independent medical review)
  iroAppealDenial: 'case-iro-001-external-appeal',
  ireMedicalNecessity: 'case-ire-002-medical-necessity-review',
} as const;
...
export const demoDeterminationTemplates: DeterminationTemplate[] = [
  ...
  // IDR-specific templates for Payer IDR (NSA) cases
  {
    id: 'dt-idr-001-upheld',
    created_at: '2025-06-01T08:00:00.000Z',
    client_id: null,
    template_type: 'idr_offer_upheld',
    name: 'IDR Offer Upheld',
    body_template: 'Dear {{provider_name}},\n\nThe IDR entity has reviewed the Payer IDR dispute for the following claim:\n\nCase: {{case_number}}\nPatient: {{patient_name}} (Member ID: {{member_id}})\nService: {{procedure_description}}\nBilled Amount: ${{billed_amount}}\n\nDETERMINATION: OFFER UPHELD\n\nThe payer\'s Qualifying Payment Amount (QPA) of ${{qpa_amount}} was determined to be appropriate after consideration of the billed charge, out-of-network status, and additional circumstances submitted.\n\nRationale: {{rationale}}\n\nThis determination is binding for the parties. Payment should be made in accordance with the upheld offer.\n\nSincerely,\nVanta Health Group IDR Entity',
    appeal_instructions: 'This IDR determination is binding and generally not subject to further administrative appeal under the No Surprises Act. Parties may have judicial review rights in limited circumstances.',
    is_active: true,
  },
  {
    id: 'dt-idr-002-modified',
    created_at: '2025-06-01T08:00:00.000Z',
    client_id: null,
    template_type: 'idr_offer_modified',
    name: 'IDR Offer Modified',
    body_template: 'Dear {{provider_name}},\n\nThe IDR entity has reviewed the Payer IDR dispute:\n\nCase: {{case_number}}\nPatient: {{patient_name}}\nService: {{procedure_description}}\nBilled: ${{billed_amount}} | Original Offer (QPA): ${{qpa_amount}}\n\nDETERMINATION: OFFER MODIFIED\n\nAfter review of all submitted information including the billed charge, QPA calculation, network status, and additional circumstances, the appropriate payment amount is determined to be ${{modified_amount}}.\n\nRationale / Key Factors: {{rationale}}\n\nThe payer shall remit payment based on the modified amount.\n\nSincerely,\nVanta Health Group IDR Entity',
    appeal_instructions: 'Per NSA, this determination is binding on the parties for the items/services in dispute.',
    is_active: true,
  },
  // IRO/IRE external review templates (Phase B)
  {
    id: 'dt-iro-001-approved',
    created_at: '2025-06-01T08:00:00.000Z',
    client_id: null,
    template_type: 'iro_approved',
    name: 'IRO Approved',
    body_template: 'Dear {{provider_name}},\n\nThe Independent Review Organization has completed its external review for the following case:\n\nCase: {{case_number}}\nPatient: {{patient_name}}\nService: {{procedure_description}}\n\nDETERMINATION: APPROVED\n\nAfter independent review of the clinical documentation and applicable criteria, the requested service is approved.\n\nRationale: {{rationale}}\n\nThis determination is independent of any prior internal review.\n\nSincerely,\nVantaUM IRO Panel',
    appeal_instructions: 'This IRO determination may be subject to further appeal per plan terms.',
    is_active: true,
  },
  {
    id: 'dt-iro-002-denied',
    created_at: '2025-06-01T08:00:00.000Z',
    client_id: null,
    template_type: 'iro_denied',
    name: 'IRO Denied',
    body_template: 'Dear {{provider_name}},\n\nThe Independent Review Organization has completed its external review:\n\nCase: {{case_number}}\nPatient: {{patient_name}}\nService: {{procedure_description}}\n\nDETERMINATION: DENIED\n\nAfter independent review, the service does not meet the external review standard.\n\nRationale: {{rationale}}\n\nThis is an independent determination.\n\nSincerely,\nVantaUM IRO Panel',
    appeal_instructions: 'Further appeal rights may apply.',
    is_active: true,
  },
];
...
export const demoCases: Case[] = [
  ...
  // IDR / Payer IDR cases (for IDR chassis testing & model training data)
  // Cast to any to satisfy full Case interface for demo purposes (many UM fields not relevant)
  {
    id: DEMO_CASE_IDS.idrAirAmbulance,
    created_at: daysAgo(2, 5),
    updated_at: daysAgo(0, 12),
    ...
    patient_dob: '04/22/1988',
    patient_member_id: 'PPO-88421',
    patient_gender: 'M',
    requesting_provider: 'Metro Air Ambulance Services',
    requesting_provider_npi: '1234567890',
    requesting_provider_specialty: 'Air Ambulance',
    ...
    plan_type: 'PPO',
    clinical_question: 'Is the billed charge of $48,500 for air ambulance transport reasonable given the qualifying payment amount of $12,400 and the patient\'s post-MVA condition?',
    assigned_idr_attorney_id: 'attorney-demo-1',
    denial_reason: 'Payment reduced to QPA per plan policy for air ambulance.',
    turnaround_deadline: daysAgo(-1, 0),
    client: demoClients[0],
    submitted_documents: [],
    assigned_pod_id: null,
    assigned_lpn_id: null,
  ...
  } as any,
  {
    ...
    patient_dob: '09/11/1975',
    patient_member_id: 'PPO-99102',
    patient_gender: 'F',
    requesting_provider: 'Dr. Patel at Metro Surgical Center (OON)',
    requesting_provider_npi: '9876543210',
    requesting_provider_specialty: 'Orthopedic Surgery',
    servicing_provider: 'Metro Surgical Center',
    servicing_provider_npi: '9876543210',
    facility_name: 'Metro Surgical Center',
    facility_type: 'asc',
    procedure_codes: ['27447'],
    procedure_description: 'Total knee arthroplasty - facility fee component',
    diagnosis_codes: ['M17.12'],
    billed_amount_cents: 2850000,
    is_out_of_network: true,
    payer_name: 'Pinnacle Health Plan',
    plan_type: 'PPO',
    clinical_question: 'Appropriate payment for facility fee when patient received care at out-of-network ambulatory surgery center following in-network surgeon referral.',
    turnaround_deadline: daysAgo(0, 4),
    client: demoClients[1],
    submitted_documents: [],
    assigned_pod_id: null,
    assigned_lpn_id: null,
  ...
  // IRO / External Independent Review cases (for IRO/IRE dashboard surfaces + shared chassis)
  {
    id: DEMO_CASE_IDS.iroAppealDenial,
    created_at: daysAgo(3, 2),
    updated_at: daysAgo(0, 4),
    case_number: 'VUM-IRO-0401',
    case_type: 'iro',
    appeal_of_case_id: DEMO_CASE_IDS.mriLumbar, // link to original for independence wall test
    status: 'md_review',
    priority: 'standard',
    service_category: 'surgery',
    review_type: 'appeal',
    patient_name: 'Marcus Hale',
    patient_dob: '1969-02-14',
    patient_member_id: 'TPA-55678',
    patient_gender: 'M',
    requesting_provider: 'Dr. Susan Kim',
    requesting_provider_npi: '3344556677',
    requesting_provider_specialty: 'Orthopedics',
    servicing_provider: 'Regional Surgical Center',
    servicing_provider_npi: '9988776655',
    facility_name: 'Regional Surgical Center',
    facility_type: 'asc',
    procedure_codes: ['29881'],
    procedure_description: 'Knee arthroscopy with meniscectomy - appeal of prior denial',
    diagnosis_codes: ['M23.203'],
    billed_amount_cents: 1425000,
    is_out_of_network: false,
    client_id: DEMO_CLIENT_IDS.southwestAdmin,
    payer_name: 'Southwest Administrators',
    plan_type: 'PPO',
    turnaround_deadline: hoursFromNow(48),
    sla_hours: 72,
    ai_brief: null,
    ai_brief_generated_at: daysAgo(2, 10),
    fact_check: null,
    fact_check_at: null,
    determination: null,
    determination_rationale: null,
    determination_at: null,
    determined_by: null,
    internal_notes: 'External IRO referral. Original denial for medical necessity per MCG. Additional operative report + post-op imaging attached for second-level review.',
    submitted_documents: ['appeal_letter.pdf', 'op_report.pdf', 'postop_mri.pdf', 'prior_denial_letter.pdf'],
    assigned_reviewer_id: null,
    vertical: 'medical',
    sla_paused_at: null,
    sla_resumed_at: null,
  ...
  {
    id: DEMO_CASE_IDS.ireMedicalNecessity,
    created_at: daysAgo(1, 14),
    updated_at: daysAgo(0, 1),
    case_number: 'VUM-IRE-0402',
    case_type: 'ire',
    status: 'processing',
    priority: 'expedited',
    service_category: 'infusion',
    review_type: 'second_level_review',
    patient_name: 'Priya Singh',
    patient_dob: '1982-07-02',
    patient_member_id: 'HMO-33102',
    patient_gender: 'F',
    requesting_provider: 'Dr. Leo Martinez',
    requesting_provider_npi: '1122334455',
    requesting_provider_specialty: 'Oncology',
    servicing_provider: 'City Infusion Center',
    servicing_provider_npi: '5544332211',
    facility_name: 'City Infusion Center',
    facility_type: 'office',
    procedure_codes: ['J9312'],
    procedure_description: 'Rituximab infusion for refractory RA - IRE requested by plan',
    diagnosis_codes: ['M05.79'],
    billed_amount_cents: 980000,
    is_out_of_network: null,
    client_id: DEMO_CLIENT_IDS.pinnacleHealth,
    payer_name: 'Pinnacle Health Plan',
    plan_type: 'HMO',
    ...
    determination_at: null,
    determined_by: null,
    internal_notes: 'Independent medical review (IRE) for coverage dispute. Requires specialist review outside plan network.',
    submitted_documents: ['specialist_consult.pdf', 'infusion_history.pdf', 'lab_results.pdf', 'plan_coverage_denial.pdf'],
    assigned_reviewer_id: null,
    vertical: 'medical',
    sla_paused_at: null,
    sla_resumed_at: null,
