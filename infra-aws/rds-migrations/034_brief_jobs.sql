-- Migration 034 (RDS variant) — Brief-generation job queue
-- Identical to supabase/migrations/034_brief_jobs.sql minus RLS (RDS uses vantaum_admin). (throughput chassis)
--
