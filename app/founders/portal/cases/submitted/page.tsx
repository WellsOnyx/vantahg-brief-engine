  ...
  return (
    <div className="max-w-xl mx-auto pt-12 text-center space-y-4">
      ...
      <div className="pt-4 flex items-center justify-center gap-3">
        <Link href="/founders/portal/submit" className="text-sm border border-slate-300 rounded px-4 py-2 hover:bg-slate-50">
          Submit another
        </Link>
        <Link href="/founders/portal" className="text-sm bg-[#0c2340] text-white rounded px-4 py-2 hover:bg-[#173869]">
          Back to portal
        </Link>
      </div>
    </div>
