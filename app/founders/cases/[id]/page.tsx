...
export default function FoundersCaseDetailPage() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-end justify-between">
        <div>
          <Link href="/founders/queue" className="text-xs text-slate-500 hover:text-slate-900">
            ← Back to queue
          </Link>
