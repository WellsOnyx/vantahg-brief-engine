/**
 * POST /api/intake/voice — Canonical Intake Contract v1, phone channel.
 *
 ...
 *     verified against up to two active secrets (rotation without downtime).
 *     Timestamps outside ±300s are rejected as replays.
 *   - Required envelope: contract_version "1.0", opaque submission_id,
