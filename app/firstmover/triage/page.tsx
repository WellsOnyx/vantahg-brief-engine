...
import type { TriageDecision, TriageLane } from '@/lib/firstmover/triage';
...
export default function FirstMoverTriagePage() {
  ...
  async function runTriage() {
    ...
    try {
      const res = await fetch('/api/firstmover/triage', {
        method: 'POST',
                ...
                return (
                  <tr key={c.id} className="border-t border-slate-100 align-top">
                    ...
                    <td className="px-3 py-3 font-mono text-xs">
                      <Link href={`/firstmover/cases/${c.id}`} className="hover:underline">
                        {c.case_number}
                      </Link>
                    </td>
                    <td className="px-3 py-3">
