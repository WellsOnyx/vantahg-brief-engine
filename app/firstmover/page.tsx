...
export default function FirstMoverHome() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="font-serif text-3xl">First Mover</h1>
