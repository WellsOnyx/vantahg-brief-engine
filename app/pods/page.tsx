...
export default function PodsPage() {
 ...
 <h3 className="font-semibold text-base">No pods configured</h3>
 ...
 <h3 className="text-lg text-navy">{pod.name}</h3>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 flex items-start justify-center z-50 overflow-y-auto py-8">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl mx-4 animate-scale-in">
            <div className="px-6 py-4 border-b border-border flex items-center justify-between">
 <h3 className="text-xl text-navy">{editingPod ? 'Edit Pod' : 'Create Pod'}</h3>
