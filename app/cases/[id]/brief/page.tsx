      ...
      <div className="px-8 py-6">
        ...
        <div className="flex items-center justify-between border-b-2 border-navy pb-4 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-[family-name:var(--font-dm-serif)] text-xl text-navy">VantaUM</div>
        ...
        <div className="border-t-2 border-gray-300 pt-6 mt-8">
          ...
          <p className="text-[10px] text-muted mt-4">
            This clinical brief was generated by VantaUM&apos;s AI Clinical Brief Engine to assist in the review process.
